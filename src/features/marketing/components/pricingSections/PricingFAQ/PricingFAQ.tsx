...
export const PricingFAQ = (props: PricingFAQProps) => {
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800 lg:border-0 lg:pt-8">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12">
            <h2 className="text-4xl text-gray-50">Frequently asked questions</h2>
          </div>

          {/* Faqs */}
          <ul className="grid gap-8 md:grid-cols-2 xl:gap-x-16 lg:gap-y-12">
            <li>
              <h4 className="text-xl text-gray-50 font-medium mb-2">
