...
const tabs = [
  ...
  { name: "Team Members", value: "Team Members" },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12" data-aos-id-tabs>
            <h2 className="text-4xl text-gray-50 mb-4" data-aos="fade-up">
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                      <h4 className="text-2xl text-gray-50 mb-2">
                      ...
                      <a
                        className="py-1 px-1.5 rounded-md text-white bg-purple-600 hover:bg-purple-700 mt-6 flex w-fit items-center justify-center"
                        href="#0"
                      >
                        <span className="text-sm">Learn more</span>
                        <ArrowRightIcon className="w-5 h-5 fill-current text-purple-200 shrink-0 ml-2" />
                      </a>
                    </div>
                  </article>
                </Transition>
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    <figure className="md:absolute md:inset-y-0 md:left-0 md:w-1/2">
                      <img
                        className="w-full h-full object-cover"
                        src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8dGVjaG5vbG9neXxlbnwwfHwwfHx8MA%3D%3D"
                        width={516}
                        height={387}
                        alt="Tabs 02"
                      />
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    <figure className="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                      <img
                        className="w-full h-full object-cover"
                        src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHRlY2hub2xvZ3l8ZW58MHx8MHx8fDA%3D"
                        width={516}
                        height={387}
                        alt="Tabs 01"
                      />
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    <figure className="md:absolute md:inset-y-0 md:left-0 md:w-1/2">
                      <img
                        className="w-full h-full object-cover"
                        src="https://images.unsplash.com/photo-1517433456452-f9633a875f6f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjh8fHRlY2hub2xvZ3l8ZW58MHx8MHx8fDA%3D"
                        width={516}
                        height={387}
                        alt="Tabs 02"
                      />
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    <figure className="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                      <img
                        className="w-full h-full object-cover"
                        src="https://images.unsplash.com/photo-1503437313881-503a91226402?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzV8fHRlY2hub2xvZ3l8ZW58MHx8MHx8fDA%3D"
                        width={516}
                        height={387}
                        alt="Tabs 01"
                      />
